...
from .views import LeaseListView, LeaseDetailView, LeaseCreateView, LeaseUpdateView, LeaseDeleteView, renew_lease, MaintenanceRequestAdminListView, MaintenanceRequestAdminUpdateView, DocumentUploadView, DocumentDeleteView, ExpenseListView, ExpenseCreateView, ExpenseUpdateView, ExpenseDeleteView, ReportSelectionView, GenerateTenantStatementPDF, GenerateMonthlyPLReportPDF
...
urlpatterns = [
  ...
  path('leases/<int:pk>/renew/', renew_lease, name='lease_renew'),
