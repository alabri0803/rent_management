  ...
  def __init__(self, *args, **kwargs):
    ...
    for field_name, field in self.fields.items():
      if field_name != 'receipt':
        ...
        field.widget.attrs.update({'class':'w-full text-sm text-gray-500 file:px-4 file:mr-4 file:py-2 file:border-0 file:text-sm file:font-semibold file:bg-bule-50 file:text-bule-700 hover:file:bg-bule-100'})